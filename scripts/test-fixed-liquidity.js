...
async function main() {
  console.log("💧 Testing liquidity with correct gas settings...");
  ...
  try {
    ...
    const gasPrice = feeData.gasPrice ? feeData.gasPrice * 2n : ethers.parseUnits("30", "gwei"); // Use 30 gwei minimum
    ...
    // Approve tokens with correct gas settings
    ...
    // Add liquidity with correct gas settings
